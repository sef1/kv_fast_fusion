...
def execute_model_v1(
        ...
        attn_metadata['scaling_factors'] = [{req: self.compression_hook.norms_k[req]} for req in fused_reqs]
        self.compression_hook.req_idx = req_idx
        ...
        if self.compression_hook and len(req_to_compress) > 1 : #and not is_decode:                     
            ...
            # Model forward pass - each layer will trigger compression 
                ...
                **MultiModalKwargs.as_kwargs(
                ...
                # self.reqs_rescalings  = (self.compression_hook.norms_k, self.compression_hook.norms_v)
                self.fused_requests.extend(req_to_compress)  ############################################################# return this line!! 
